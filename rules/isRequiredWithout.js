...
export default function (...others) {
  return function isRequiredWithout({value, data, attribute, messages}) {
    ...
    return {
      passes() {
        ...
        return _others.some(other => !assertEmpty(data[other]));
      },
      message(msg = ":attribute is required when :others is missing.") {
        return msg
